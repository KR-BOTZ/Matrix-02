    ...
    try:
            ...
            if n_offset == 0:
                ...
                btn.append(
                    [
                        ...
                        InlineKeyboardButton("Nxᴛ ≻≻ ", callback_data=f"next_{req}_{key}_{n_offset}")
                    ],
                )
        else:
        ...
        if settings['max_btn']:
            ...
            if n_offset == 0:
                ...
                btn.append([InlineKeyboardButton("Pᴀɢᴇ", callback_data="pages"), InlineKeyboardButton(f"{math.ceil(int(offset)/int(MAX_B_TN))+1} / {math.ceil(total/int(MAX_B_TN))}", callback_data="pages"), InlineKeyboardButton("𝐍𝐄𝐗𝐓 ➪", callback_data=f"next_{req}_{key}_{n_offset}")])
            else:
                btn.append(
                    [
                        InlineKeyboardButton("≺≺ Bᴀᴄᴋ", callback_data=f"next_{req}_{key}_{off_set}"),
...
async def cb_handler(client: Client, query: CallbackQuery):
    ...
    if query.data.startswith("file"):
                ...
                if clicked == typed:
                    await client.send_cached_media(
                        ...
                        reply_markup=InlineKeyboardMarkup(
                            [[
                            InlineKeyboardButton('Mᴏᴠɪᴇs Uᴘᴅᴀᴛᴇs', url="t.me/bgm_linkzZ"),
                            InlineKeyboardButton('Bᴏᴛ Uᴘᴅᴀᴛᴇs', url="t.me/KR_Botz")
                            ]]
                        )
                    )
                else:
        ...
        buttons = [[
            ...
            InlineKeyboardButton('🎩 Mʏ Fᴀᴛʜᴇʀ', callback_data="owner_info"),
        ...
        buttons =  [[
            InlineKeyboardButton('Sᴜᴘᴘᴏʀᴛ', url="t.me/kr_join"),
        ...
        await query.message.edit_text(
            ...
            btn = [[
                    ...
                    InlineKeyboardButton("Cᴏɴᴛᴀᴄᴛ", url="t.me/mr_tamil_kid")
                  ]]
            await client.edit_message_media(
                query.message.chat.id, 
                query.message.id, 
    ...
    if offset != "":
        ...
        try:
            ...
            if settings['max_btn']:
                ...
                btn.append(
                    [InlineKeyboardButton("Pᴀɢᴇ", callback_data="pages"), InlineKeyboardButton(text=f"1/{math.ceil(int(total_results)/int(MAX_B_TN))}",callback_data="pages"), InlineKeyboardButton(text="𝐍𝐄𝐗𝐓 ➪",callback_data=f"next_{req}_{key}_{offset}")]
                )
        except KeyError:
